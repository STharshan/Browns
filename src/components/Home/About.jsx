...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Highly recommend! Charlie has saved the day and fitted me in at very short notice on two occasions now. Always super friendly and happy to help. I won’t be going anywhere else now I’ve found Browns Garage.",
